...
For additional evaluation of the SARIMA models, we used Jupyter Notebook with Python. The packages "pathlib", "pandas", "numpy", and "statsmodels" are required for this step, though some may not be required if previously downloaded for a prior step. 
...
│
├── OUTPUT
│   ├── acousticness_sarima_coefficients.csv
│   ├── acousticness_seasonal_terms.csv
│   ├── Aggregated Song by Month Plot.png
│   ├── duration_sarima_coefficients.csv
│   ├── duration_seasonal_terms.csv
│   ├── sarima_seasonality_summary.csv
│   ├── speechiness_sarima_coefficients.csv
│   ├── speechiness_seasonal_terms.csv
│   ├── tempo_sarima_coefficients.csv
│   ├── tempo_seasonal_terms.csv
│   ├── valence_sarima_coefficients.csv
│   └── valence_seasonal_terms.csv 
│
├── SCRIPTS
